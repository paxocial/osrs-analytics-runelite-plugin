...
import com.cortalabs.osrs.analytics.beans.Snapshot;
import com.cortalabs.osrs.analytics.beans.Computed;
...
class BossingPanel extends JPanel
{
	...
	private static final List<HiscoreSkill> BOSSES = ImmutableList.of(
		...
		OBOR, PHANTOM_MUSPAH, SARACHNIS, SCORPIA, SCURRIUS, SHELLBANE_GRYPHON, SKOTIZO, SOL_HEREDIT,
