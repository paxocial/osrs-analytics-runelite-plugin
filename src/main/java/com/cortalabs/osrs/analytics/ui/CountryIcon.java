...
public enum CountryIcon
{
	...
	public static ImageIcon loadSquareImage(String languageCode)
	{
		try
		{
			return new ImageIcon(ImageUtil.loadImageResource(AnalyticsPlugin.class, "flags_square/" + ICONS.get(languageCode).codepoint + ".png"));
		}
		catch (Exception e)
		{
			return new ImageIcon(ImageUtil.loadImageResource(AnalyticsPlugin.class, "flags_square/default.png"));
		}
	}
}
