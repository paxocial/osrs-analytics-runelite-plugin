...
public class SyncButton
{
	...
	public SyncButton(Client client, AnalyticsPlugin plugin, ClientThread clientThread, AnalyticsClient womClient,
	...
	private Widget createWidgetWithText()
	{
		...
		textWidget.setText("<col=9f9f9f>" + "Sync Analytics Group" + "</col>");
		textWidget.setFontId(FontID.PLAIN_11);
		textWidget.setTextShadowed(true);

		textWidget.setAction(0, "Sync Analytics Group");
	...
	public void setEnabled(boolean isSyncing)
	{
		...
		{
			this.textWidget.setText("<col=ffffff>" + "Sync Analytics Group" + "</col>");
	...
	private void showSyncOptions()
	{
		chatboxPanelManager.openTextMenuInput(
				"Any members not in your clan will be removed" +
					"<br>from your analytics group. Proceed?")
			.option("1. Yes, overwrite analytics group", () -> clientThread.invoke(() -> syncMembers()))
